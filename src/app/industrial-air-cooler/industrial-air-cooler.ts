...
@Component({
  selector: 'app-industrial-air-cooler',
  imports: [CommonModule, FormsModule],
  templateUrl: './industrial-air-cooler.html',
  styleUrl: './industrial-air-cooler.css'
})
export class IndustrialAirCooler {
  ...
  brands: Brand[] = [
    {
      ...
      brandname: 'Breezair',
      name:'Breezair ',
      image: 'assets/brands-logo/breezair-logo.png',
      title: 'Breezair',
    ...
    },
    {
      ...
      brandname:'Symphony',
      name: 'Symphony',
      image: 'assets/brands-logo/symphony-logo.png',
      title: 'Symphony',
