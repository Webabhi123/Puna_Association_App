...
@Component({
  selector: 'app-vertical-pumps',
  imports: [CommonModule, FormsModule],
  templateUrl: './vertical-pumps.html',
  styleUrl: './vertical-pumps.css'
})
export class VerticalPumps {
  ...
  brands: Brand[] = [
    ...
    },
    {
      ...
      brandname:'Lubicon',
      name: 'Lubicon',
      image: 'assets/brands-logo/lubicon-logo.png',
      title: 'Lubicon',
