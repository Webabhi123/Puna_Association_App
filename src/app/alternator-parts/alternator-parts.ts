...
@Component({
  selector: 'app-alternator-parts',
  imports: [CommonModule, FormsModule],
  templateUrl: './alternator-parts.html',
  styleUrl: './alternator-parts.css'
})
export class AlternatorParts {
  ...
  brands: Brand[] = [
    ...
    },
    {
      ...
      name: 'Ashok Leyland',
      image: 'assets/brands-logo/ashok-leyland-logo.png',
      title: 'Ashok Leyland',
      contactName: 'Jane Smith',
      mobile: '9876543211',
      whatsapp: '9876543211',
    ...
    },
    {
      ...
      brandname:'Bharat',
      name: 'Bharat',
      image: 'assets/brands-logo/bharat-heavy-electricals-logo.png',
      title: 'Bharat',
      contactName: 'Jane Smith',
      mobile: '9876543211',
      whatsapp: '9876543211',
