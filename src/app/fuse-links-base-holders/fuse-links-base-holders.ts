...
@Component({
  selector: 'app-fuse-links-base-holders',
  imports: [CommonModule,FormsModule],
  templateUrl: './fuse-links-base-holders.html',
  styleUrl: './fuse-links-base-holders.css'
})
export class FuseLinksBaseHolders {
  ...
  brands: Brand[] = [
    {
      ...
      brandname: 'Bussmann',
      name:'Bussmann',
      image: 'assets/brands-logo/bussmann-logo.png',
      title: 'Bussmann',
