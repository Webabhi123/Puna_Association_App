...
@Component({
  selector: 'app-street-light-pole',
  imports: [CommonModule, FormsModule],
  templateUrl: './street-light-pole.html',
  styleUrl: './street-light-pole.css'
})
export class StreetLightPole {
  ...
  brands: Brand[] = [
    ...
    },
    {
      ...
      brandname:'Utkarsh',
      name: 'Utkarsh',
      image: 'assets/brands-logo/utkarsh-logo.png',
      title: 'Utkarsh',
