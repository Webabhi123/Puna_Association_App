...
@Component({
  selector: 'app-armoured-cable',
  imports: [CommonModule, FormsModule],
  templateUrl: './armoured-cable.html',
  styleUrl: './armoured-cable.css'
})
export class ArmouredCable {
  ...
  brands: Brand[] = [
    {
      ...
      email: 'info@polycab.in',
      website: 'www.polycab.in',
    ...
    },
    {
      ...
      brandname:'KEI',
      name: 'KEI',
      image: 'assets/brands-logo/kei-logo.png',
      title: 'KEI',
