...
@Component({
  selector: 'app-universal-socket',
  imports: [CommonModule,FormsModule],
  templateUrl: './universal-socket.html',
  styleUrl: './universal-socket.css'
})
  ...
  brands: Brand[] = [
    {
      ...
      brandname: 'Anchor',
      name:'Anchor',
      image: 'assets/brands-logo/anchor-logo.png',
      title: 'Anchor',
    ...
    },
    {
      ...
      brandname:'Neptune',
      name: 'Neptune',
      image: 'assets/brands-logo/neptune-logo.png',
      title: 'Neptune',
      contactName: 'Jane Smith',
      mobile: '9876543211',
      whatsapp: '9876543211',
