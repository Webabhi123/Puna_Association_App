...
@Component({
  selector: 'app-epabx-system',
  imports: [CommonModule, FormsModule],
  templateUrl: './epabx-system.html',
  styleUrl: './epabx-system.css'
})
export class EpabxSystem {
  ...
  brands: Brand[] = [
    {
      id: 1,
      brandname: 'EPABX Service',
      name:'EPABX Service',
      image: 'assets/brands-logo/epabx-logo.png',
      title: 'EPABX Service',
    ...
    {
      id: 2,
      brandname:'Intercom Installation Service',
      name: 'EPABX Service',
      image: 'assets/brands-logo/epabx-logo.png',
      title: 'EPABX Service',
