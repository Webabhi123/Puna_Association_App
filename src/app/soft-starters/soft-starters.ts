...
@Component({
  selector: 'app-soft-starters',
  imports: [CommonModule, FormsModule],
  templateUrl: './soft-starters.html',
  styleUrl: './soft-starters.css'
})
export class SoftStarters {
  ...
  brands: Brand[] = [
    ...
    },
    {
      ...
      name: 'Allen Bradley Electric',
      image: 'assets/brands-logo/schneider-logo.png',
      title: 'Allen Bradley Electric India',
      contactName: 'Jane Smith',
      mobile: '9876543211',
      whatsapp: '9876543211',
      landline: '020-1234568',
