...
@Component({
  selector: 'app-tachometers',
  imports: [CommonModule, FormsModule],
  templateUrl: './tachometers.html',
  styleUrl: './tachometers.css'
})
export class Tachometers {
  ...
  brands: Brand[] = [
    ...
    },
    {
      ...
      brandname:'Fluke',
      name: 'Fluke',
      image: 'assets/brands-logo/fluke-logo.png',
      title: 'Fluke',
    ...
    {
      id: 3,
      brandname:'Kusam Meco',
      name: 'Kusam Meco',
      image: 'assets/brands-logo/kusam-meco-logo.png',
      title: 'Kusam Meco',
      contactName: 'Jane Smith',
      mobile: '9876543211',
      whatsapp: '9876543211',
    ...
    },
    {
      ...
      brandname:'Oppama',
      name: 'Oppama',
      image: 'assets/brands-logo/oppama-logo.png',
      title: 'Oppama',
      contactName: 'Jane Smith',
      mobile: '9876543211',
      whatsapp: '9876543211',
