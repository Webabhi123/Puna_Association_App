...
@Component({
  selector: 'app-torches-emergency-light',
  imports: [CommonModule, FormsModule],
  templateUrl: './torches-emergency-light.html',
  styleUrl: './torches-emergency-light.css'
})
export class TorchesEmergencyLight {
  ...
  brands: Brand[] = [
    ...
    },
    {
      ...
      brandname:'Britelite',
      name: 'Britelite',
      image: 'assets/brands-logo/britelite-logo.png',
      title: 'Britelite',
    ...
    },
    {
      ...
      brandname:'Tuscan',
      name: 'Tuscan',
      image: 'assets/brands-logo/tuscan-logo.png',
      title: 'Tuscan',
      contactName: 'Jane Smith',
      mobile: '9876543211',
      whatsapp: '9876543211',
