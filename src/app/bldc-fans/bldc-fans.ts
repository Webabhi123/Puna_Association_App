...
@Component({
  selector: 'app-bldc-fans',
  imports: [CommonModule, FormsModule],
  templateUrl: './bldc-fans.html',
  styleUrl: './bldc-fans.css'
})
export class BldcFans {
    ...
    brands: Brand[] = [
      {
        ...
        brandname: 'Atomberg',
        name:'Atomberg ',
        image: 'assets/brands-logo/atomberg-logo.png',
        title: 'Atomberg',
      ...
      },
      {
        ...
        brandname:'Kuhl',
        name: 'Kuhl',
        image: 'assets/brands-logo/kuhl-logo.png',
        title: 'Kuhl',
        contactName: 'Jane Smith',
        mobile: '9876543211',
        whatsapp: '9876543211',
