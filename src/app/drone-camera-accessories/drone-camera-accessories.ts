...
@Component({
  selector: 'app-drone-camera-accessories',
  imports: [CommonModule,FormsModule],
  templateUrl: './drone-camera-accessories.html',
  styleUrl: './drone-camera-accessories.css'
})
export class DroneCameraAccessories {
  ...
  brands: Brand[] = [
    {
      ...
      brandname: 'DJI',
      name:'DJI ',
      image: 'assets/brands-logo/dji-logo.png',
      title: 'DJI',
    ...
    },
    {
      ...
      brandname:'Mi',
      name: 'Mi',
      image: 'assets/brands-logo/mi-logo.png',
      title: 'Mi',
