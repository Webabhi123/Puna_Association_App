...
@Component({
  selector: 'app-sewage-submersible-pumps',
  imports: [CommonModule,FormsModule],
  templateUrl: './sewage-submersible-pumps.html',
  styleUrl: './sewage-submersible-pumps.css'
})
export class SewageSubmersiblePumps {
